...
import styles from '../angularJs/AngularJsWebPart.module.scss';
import * as strings from 'AngularJsWebPartStrings';
import * as angular from 'angular';
import './app/app-module';

export interface IAngularJsWebPartProps {
  description: string;
}

export default class AngularJsWebPart extends BaseClientSideWebPart<IAngularJsWebPartProps> {
  private $injector: angular.auto.IInjectorService;
  public render(): void {
    if (this.renderedOnce === false) {

    this.domElement.innerHTML = `
    <div class="${styles.angularJs}" data-ng-controller="HomeController as vm">
